new Vue({
  ...
  data: {
    ...
    users: [
      ...
      { name: 'Janidu Arinda Fernando', score: 85, grade: 9, userId:'090741612',tasks:'6', favourite:'Design/Explore'},
      ...
      { name: 'T. Nethula Roshane Peiris', score: 58, grade: 7, userId:'070838256',tasks:'4', favourite:'Code/Design'},
      ...
      { name: 'Inuka Sanudaya Batawala', score: 71, grade: 7, userId:'070516651',tasks:'3', favourite:'Code/Design'},
      { name: 'J.B. Bihandu Semal', score: 76, grade: 9, userId:'091008008',tasks:'5', favourite:'Code/Design'},
      { name: 'J.A. Davindu Reshan', score: 66, grade: 11, userId:'111147704',tasks:'3', favourite:'Design'},
      { name: 'Chamod Nilushanka Perera', score: 110, grade: 11, userId:'111141143',tasks:'7', favourite:'Design/Explore'},
      { name: 'Nayantha Nethsara Senavithilaka', score: 32, grade: 10, userId:'101039302',tasks:'2', favourite:'Design'},
      { name: 'E.A. Chamuthu Megha Malhara Edirisooriya', score: 108, grade: 10, userId:'100148900',tasks:'7', favourite:'Code/Design'},
      ...
      { name: 'M.M.A. Pahan Samudika Abhayawardhane', score: 61, grade: 11, userId:'110418733',tasks:'2', favourite:'Design'},
      { name: 'K.A. Samiru Thisaraka De Silva', score: 87, grade: 11, userId:'110842334',tasks:'6', favourite:'Design'},
      { name: 'Benul Chenuka Wijwrathne', score: 57, grade: 11, userId:'110427637',tasks:'2', favourite:'Code/Design'},
      ...
      { name: 'Kavindu Pabasara Panditharatne', score: 109, grade: 10, userId:'101043545',tasks:'7', favourite:'Code/Design'},
      ...
      { name: 'Dulaj Bandara Weerakoon', score: 14, grade: 11, userId:'1104107222',tasks:'1', favourite:'Code'},
      { name: 'K.W. Sanithu Hasmal Kudaliyana', score: 25, grade: 8, userId:'080119696',tasks:'0', favourite:'---'},
      { name: 'L. Gothira Sathnindu Mendis', score: 30, grade: 9, userId:'090930522',tasks:'2', favourite:'Code/Design'},
    ]
  },
