new Vue({
  ...
  data: {
    ...
    users: [
      ...
      { name: 'Chamod Nilushanka Perera', score: 63, grade: 11, userId:'111141143',tasks:'4', favourite:'Design'},
      { name: 'Nayantha Nethsara Senavithilaka', score: 32, grade: 10, userId:'101039302',tasks:'2', favourite:'Design'},
      { name: 'E.A. Chamuthu Megha Malhara Edirisooriya', score: 45, grade: 10, userId:'100148900',tasks:'3', favourite:'All Rounder'},
      ...
      { name: 'Benul Chenuka Wijwrathne', score: 25, grade: 11, userId:'110427637',tasks:'0', favourite:'---'},
      ...
      { name: 'Kavindu Pabasara Panditharatne', score: 30, grade: 10, userId:'101043545',tasks:'2', favourite:'Design/Explore'},
      { name: 'Osanda Samaratunge', score: 18, grade: 11, userId:'111134290',tasks:'1', favourite:'Design'},
      { name: 'S. Chandupa Yasas Silva', score: 16, grade: 10, userId:'100944124',tasks:'1', favourite:'Design'},
    ]
  },
