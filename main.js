new Vue({
  ...
  data: {
    ...
    users: [
      ...
      { name: 'Heliya Nithira Suriya Bandara', score: 164(44+120), grade: 11, userId:'111101615',tasks:'3', favourite:'Design', rank:'5', awards:'Still Graphics 3D 10-11'},
      ...
      { name: 'Senel Demintha', score: 53(28+0+25), grade: 11, userId:'110214810',tasks:'2', favourite:'Design/Explore', rank:'15'},
      { name: 'Banuja Nethusara Dehigaspage', score: 18, grade: 8, userId:'080830456',tasks:'1', favourite:'Design', rank:'23'},
      { name: 'Inuka Sanudaya Batawala', score: 191(46+120+25), grade: 7, userId:'070516651',tasks:'3', favourite:'Code/Design', rank:'2', awards:'Still Graphics 3D 6-9'},
      { name: 'J.B. Bihandu Semal', score: 88, grade: 9, userId:'091008008',tasks:'6', favourite:'Design', rank:'11'},
      { name: 'J.A. Davindu Reshan', score: 94(69+0+25), grade: 11, userId:'111147704',tasks:'5', favourite:'All Rounder', rank:'10'},
      { name: 'Chamod Nilushanka Perera', score: 230(110+120), grade: 11, userId:'111141143',tasks:'7', favourite:'Design/Explore', rank:'1',awards:'Still Graphics 2D 10-11'},
      ...
      { name: 'M.M.A. Pahan Samudika Abhayawardhane', score: 181(36+120+25), grade: 11, userId:'110418733',tasks:'2', favourite:'Design', rank:'3', awards:'Motion Graphics 2D 10-11'},
      { name: 'K.A. Samiru Thisaraka De Silva', score: 87, grade: 11, userId:'110842334',tasks:'6', favourite:'Design/Explore', rank:'12'},
      { name: 'Benul Chenuka Wijwrathne', score: 177(32+120+25), grade: 11, userId:'110427637',tasks:'2', favourite:'Code/Design', rank:'4', awards:'Motion Grphics 3D 10-11'},
      { name: 'Senura Danitha Ratnayake', score: 25(0+0+25), grade: 6, userId:'061142574',tasks:'0', favourite:'---',rank:'21'},
      ...
      { name: 'K.W. Sanithu Hasmal Kudaliyana', score: 25(0+0+25), grade: 8, userId:'080119696',tasks:'0', favourite:'---',rank:'21'},
